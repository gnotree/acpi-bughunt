...
Enable Secure Measures: Turn on UEFI Secure Boot and ensure kernel lockdown is enforced. On supported Intel platforms, enable SMM write-protection (e.g. set SMM_BWP=1 and BIOS Lock Enable) so the BIOSSEL and BIOSWE bits become immutable after initialization[7]. 
...
Lenovo Product Security Advisories (e.g. PSIRT LEN-73440 for BIOS SPI write-protection bypass)[2]. 

Szonyi, E. et al., “When Secure Isn’t Secure: UEFI vulnerabilities in Lenovo laptops,” ESET WeLiveSecurity (Apr 2022)[1][2]. 

Red Hat Security Blog, “CVE-2020-14372: Bypassing Linux kernel lockdown via ACPI”[3][4]. 

Eclypsium, “Firmware Security Realizations – Part 3: SPI Write Protections” (Jan 2020)[5]. 

CERT/CC VU#766164 (2015), “Intel BIOS Write Protection Race Condition” (discussing BIOSWE/BLE)[6][7]. 

ACPI specification (Advanced Configuration and Power Interface)[8]. 

CyberianCherubim, “ACPI Bug Hunt” GitHub repository (analysis and logs)【cyberiancherubim/acpi-bughunt】. 

 

[1] When "secure" isn't secure at all: UEFI vulnerabilities in Lenovo laptops 
...
[3] NVD - cve-2020-14372 

https://nvd.nist.gov/vuln/detail/cve-2020-14372 

[4] RHSB-2021-003 ACPI Secure Boot vulnerability - GRUB 2 - (CVE-2020-14372) | Red Hat Customer Portal 

https://access.redhat.com/security/vulnerabilities/RHSB-2021-003 

[5] Firmware Security Realizations - Part 3 - SPI Write Protections - Eclypsium | Supply Chain Security for the Modern Enterprise 

https://eclypsium.com/blog/firmware-security-realizations-part-3-spi-write-protections/ 

[6] [7] VU#766164 - Intel BIOS locking mechanism contains race condition that enables write protection bypass 
